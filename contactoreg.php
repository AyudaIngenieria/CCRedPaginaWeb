    ...
    <nav class="navbar navbar-inverse navbar-static-top">
        ...
        <div class="row">
          ...
          <div class="col-sm-1">
            ...
            <div class="col-sm-1">
              <ul class="nav navbar-nav">
                <li>
                  <a href="galeriareg.html"><font color="#94840D">Galería</font></a>
                </li>
              </ul>
            </div>
            <div class="col-sm-1">
            ...
            <div class="col-sm-1">
              <ul class="nav navbar-nav">
                <li class="active">
                  <a href="contactoreg.php"><font color="#94840D">Contacto</font></a>
                </li>
              </ul>
            </div>
            ...
            <div class="col-sm-2">
              <ul class="nav navbar-nav">
                <li>
                  <a href="tiendaccred.php"><i class="glyphicon glyphicon-shopping-cart" style="color:#94840D" title="Tienda"></i></a>
                </li>
              </ul>
              <ul class="nav navbar-nav">
                <li>
      ...
      <!-- Inicia el formulario -->
        <div class="container-fluid">
            ...
            <fieldset>
              <!-- Form Name -->
              <legend><h1><font color="#94840D">Contacto</font></h1></legend>
            ...
            <legend><h1><font color="#94840D">Vísitanos</font></h1></legend>
            <h4>Vísitanos en nuestras oficinas centrales ubicadas en: </h4>
              ...
              <br>
              <br>
              <legend><h1><font color="#94840D">Presencia CCred</font></h1></legend>
              ...
              <br>
              <br>
              <legend><h1><font color="#94840D">Próximamente</font></h1></legend>
        ...
        <footer class="footer-distributed">
          ...
          <div class="footer-center" align="center">
            <p class="footer-links" style="margin-bottom;">
              <a href="indexreg.html" align="center"><font color="#94840D">Inicio</a>·</font>
              <a href="nosotrosreg.html" align="center"><font color="#94840D">Nosotros</a>·</font>
